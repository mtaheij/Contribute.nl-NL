...
2. Wanneer u hierom wordt gevraagd, selecteert u uw GitHub-account als de doellocatie waar de fork moet worden gemaakt. Hiermee wordt binnen uw GitHub-account een kopie gemaakt van de opslagplaats, ook wel een fork genoemd.
